			...
			var o = layui.jquery,
				...
				i.prototype.tree = function(e, a) {//生成树
					...
					layui.each(n, function(a, n) {
						// n.spread = n.state == "open"?true:false;//原先
						n.spread = n.state = true;//新 默认全部展开
						// var id = r.uuid();
						// n.id = id;//给每一个节点都设置id
							...
							s = o(
									[
										...
										function() {
											...
											var eleStr = i.check&&i.check=="checkbox" ? '<input style="display:inline-block;vertical-align: middle;" type="checkbox" '+((n.checked&&n.checked==true) ? 'checked="checked"' : "")+(n.attributes ? ('value="' + n.attributes + '"') : "") + 'data-parent-id="' + n.pid +'"' + 'id="' + n.id + '"' +(i.checkboxStyle ? (' style="' + i.checkboxStyle + '"') : "" ) :  '';
											if(eleStr.length > 0){
												//给元素添加data-xxx属性
				...
				i.prototype.changed = function (e,o){
					...
					if(o.pid == undefined || o.pid == null){
						e.children("input").on("change",function (){
							...
							try{r.options.onchange(o);}catch(e){}
						});
					}else{
						e.children("input").on("change",function (){
				...
				i.prototype.currentChildrenInputs = function (ele){
					...
					var childrenInputs = [];
					if (ele == null) return childrenInputs;
					var parent = ele.parentElement;
				...
				i.prototype.click = function(e, d) {
					var a = this,
						r = a.options,
						u = o(r.elem)[0];
					e.children("a").on("click", function(e) {
						if(!this.style.backgroundColor){
							u.selected && (u.selected.style.backgroundColor = "");
				...
				i.prototype.back = function(){
					var t = this,
						r = t.options;
					back.prototype.getVal = function(name){
						if(!name)return undefined;
						var obj = {
							data: function () { return t.data.data },
							datas: function () {
								var arr = [];
								var u = o(r.elem).find("input:checked");
								layui.each(u, function (k, v) {
									arr.push(v.data);
								});
								return arr;
							}
				...
				e("topology", function(e) {
					if (typeof e.nodes == 'string'){
						$.getJSON(e.nodes, function (data) {
							e.nodes = data;
							var r = new i(e = e || {}),
								t = o(e.elem);
							return t[0] ? r.init(t) : a.error("layui.tree 没有找到" + e.elem + "元素");
						});
					}else{
						var r = new i(e = e || {}),
							t = o(e.elem);
