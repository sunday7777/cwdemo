...
<form class="layui-form" lay-filter="userEditForm" style="margin: 30px 30px 30px 10px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="realname" placeholder="请输入真实姓名" value="${user.realname}" lay-verify="realname" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">上传头像</label>
        <div class="layui-input-block">
            <img id="headImg" src="/system/user/getUserImg?userid=${user.id}" style="width: 200px;height: 150px"/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="username" placeholder="请输入用户名" value="${user.username}" lay-verify="username" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">密码</label>
        <div class="layui-input-block">
            <input type="password" name="password" placeholder="请输入密码" value="${user.password}" lay-verify="password" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="phone" value="${user.phone}" placeholder="请输入电话" lay-verify="required|phone" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">电子邮箱</label>
        <div class="layui-input-block">
            <input type="text" name="email" value="${user.email}" placeholder="请输入电子邮箱" lay-verify="required|email"  autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    layui.use(['form','zdy','upload'], function(){
        ...
        //用户组默认值
        $(".groupid").find("option[value=${user.groupid}]").prop("selected",true);
        form.render();

        //监听提交
        form.on('submit(*)', function (data) {
            zdy.form({
                url: "/system/user/userEdit"
